...
class TestValidateGithubUrl:
    ...
    def test_valid_github_url_www(self):
    ...
    def test_github_url_with_hyphen(self):
    ...
    def test_github_url_with_underscore(self):
    ...
    def test_github_url_with_dot(self):
        """Test validation of GitHub URL with dot in names."""
        owner, repo = validate_github_url("https://github.com/my.user/my.repo")
        assert owner == "my.user"
        assert repo == "my.repo"

    def test_github_url_with_numbers(self):
    ...
    def test_missing_repo_name_raises_error(self):
        """Test that URL with only owner raises error."""
        with pytest.raises(SystemExit):
            validate_github_url("https://github.com/user")

    def test_too_many_path_segments_raises_error(self):
