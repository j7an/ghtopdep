...
class TestCLIBasic:
    ...
    def test_cli_missing_url_argument(self, cli_runner):
        """Test CLI with missing URL argument."""
        result = cli_runner.invoke(cli, [])
        assert result.exit_code != 0

    def test_cli_invalid_url_format(self, cli_runner):
...
class TestCLIURLValidation:
    ...
    def test_cli_valid_github_url(self, cli_runner):
...
class TestCLIEnvironmentVariables:
    ...
    def test_cli_requires_token_for_description(self, cli_runner):
    ...
    def test_cli_report_requires_base_url(self, cli_runner):
...
class TestCLIErrorHandling:
    ...
    def test_cli_connection_error_handled(self, cli_runner):
        ...
        with patch("ghtopdep.cli.get_max_deps", return_value=0):
            with patch("ghtopdep.cli.github3.login") as mock_login:
                ...
                result = cli_runner.invoke(
                    cli,
                    ["https://github.com/user/repo", "--description", "--token", "invalid"],
                )
...
class TestCLIOutputModes:
    ...
    def test_cli_default_table_output(self, cli_runner):
